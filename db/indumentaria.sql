...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-10-2022 a las 00:52:14
...
(3, 2, 'Mujer', 'M', 'Gris', 'Calza', './imgs/clothing/D_NQ_NP_850013-MLA49576215736_042022-W.jpg'),
...
(27, 4, 'Mujer', 'S', 'Vileta', 'Cardigan', './imgs/clothing/Su-ter-de-lana-para-mujer-c-rdigan-fino-suelto-flor-p-rpura-Primavera-2021.jpg'),
...
(32, 3, 'Mujer', 'XXL', 'Blanco', 'Blazer ', './imgs/clothing/istockphoto-451301207-612x612.jpg'),
...
(46, 1, 'Mujer', 'S', 'Rojo', 'Campera', './imgs/clothing/6349e023ea654.jpg'),
(50, 1, 'Mujer', 'L', 'Negro', 'Jean', './imgs/clothing/20210523_1352581-4ab72a32b1939ec99516218022704035-640-0.jpg'),
(51, 1, 'Mujer', 'L', 'Rosa', 'Chomba', './imgs/clothing/D_NQ_NP_775227-MLA51377479007_092022-V.jpg'),
(52, 1, 'Mujer', 'S', 'Rojo', 'vestido', './imgs/clothing/6349d2a09fee0.jpg'),
...
(1, 'Algodón', 'Es un material muy resistente. Se puede teñir y también blanquear sin problemas. Es una tela respirable. Es aislante, por eso nos puede abrigar en invierno.', 'Se aconseja lavar a mano pero se puede lavar en el lavarropas.', 'Se recomienda lavar con agua fría.', './imgs/categories/6349e06e4c126.jpg'),
(2, 'Poliéster', ' Es un tejido ligero y de poco peso, a pesar de su gran resistencia. Admite tintes y productos químicos con gran facilidad, por lo tanto tendremos una gran variedad de diseños estampados en las prendas fabricadas.', 'Se puede lavar en el lavarropas.', 'Agua tibia o fría.', './imgs/categories/6349deb200167.jpg'),
(3, 'Seda', 'Esta fibra se caracteriza por su suavidad y brillo único. Además, tiene una alta resistencia a la tracción y una alta tenacidad.', 'Se lava a mano. No se recomienda lavar en el lavarropas.', 'Agua fría. ', './imgs/categories/seda_5432376_GHR_ILUHV.jpg'),
...
(8, 'Acetato', 'No se encoge ni destiñe ni se arruga. Puede ser teñida en prácticamente cualquier color. Es una tela flexible. ', 'Puede lavar su prenda a mano o en el lavarropas.', 'Agua fría.', './imgs/categories/d09-075-tela-acetato-violeta-tienda-de-telas-online-21-aa1c2395bfc2fa238416012534726921-1024-1024.jpg'),
...
--
ALTER TABLE `tela`
  MODIFY `id_tela` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
